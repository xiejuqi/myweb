...
public class RedisClient extends BaseLogger {
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, "192.168.122.129", 6379);
	}
	...
	private void initialShardedPool() {
		...
		shards.add(new JedisShardInfo("192.168.122.129", 6379, "master"));
	...
	private void SortedSetOperate() {
		logger.info("[进入SortedSetOperate....]");

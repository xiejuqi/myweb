...
<script type="text/javascript" charset="utf-8" src="<%=path%>/js/jquery.ajaxfileupload.js"></script>
...
function ajaxFileUpload(){  
    ...
    $.ajaxFileUpload({  
        ...
        //url:'/myweb/fileUpload.html?uname=玄玉',  
        url:'/myweb/readExcel.html?uname=555',  			//用于导入Excel文件
        secureuri:false,                           //是否启用安全提交,默认为false   
        fileElement:$('#myBlogImage'),               //文件选择框的id属性  
